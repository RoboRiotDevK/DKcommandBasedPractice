...
public class simpleDriveCommand extends Command{
  ...
  public void driveForAuto(ChassisSpeeds moveSpeeds) {
        ...
        if(x==0 && y==0 && z!=0){
            ...
            FLM.setTargetVelocity(0, drivetrain.frontLeftMotor);
            FRM.setTargetVelocity(0, drivetrain.fronttRightMotor);
            BLM.setTargetVelocity(0, drivetrain.backRightMotor);
            BRM.setTargetVelocity(0, drivetrain.backLeftMotor);                //System.out.println("it's supposed to be STOPPED");
        }
}
